...
const artifactDescFilename = 'main.md'
...
export function getArtifactBySlug(slug, fields = []) {
  const cleanSlug = slug.replace(/\.md$/, '')
  const pathToArtifactDir = join(artifactsDirectory, cleanSlug)
  const pathToArtifactDesc = join(pathToArtifactDir, artifactDescFilename)
